...
public class CadMedController implements Initializable {
    ...
    @FXML
    private Button btVisuMed;
    @FXML
    private Button btpesquisarMedicamento;
    @FXML
    private Button btvoltar;
    @FXML
    private RadioButton rbRemedio;
    @FXML
    ...
    public void Cadastrar() {
        ...
        if (codigo.isEmpty() || nome.isEmpty() || preco.isEmpty()) {

            alerta("System Message", "TODOS OS CAMPOS DEVEM ESTAR PREENCHIDOS", "", Alert.AlertType.ERROR);
            ...
            if (validaCodRemedio()) {
                ...
                if (med.insertRemedio(remedio)) {
                    ...
                    alerta("System Message", "REMÉDIO CADASTRADO COM SUCESSO", "", Alert.AlertType.CONFIRMATION);

                } else {

                    alerta("System Message", "REMÉDIO NÃO CADASTRADO", "", Alert.AlertType.ERROR);
    ...
    public Alert alerta(String titulo, String header, String content, AlertType tipo) {
